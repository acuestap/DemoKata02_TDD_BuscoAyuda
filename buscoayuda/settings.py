...
DATABASES = {
   'default': {
       ...
       'NAME': os.environ['BuscoAyudaTDD_DATABASE_NAME'],
       'USER': os.environ['BuscoAyudaTDD_DATABASE_USER'],
       'PASSWORD': os.environ['BuscoAyudaTDD_DATABASE_PASSWORD'],
       'HOST': os.environ['BuscoAyudaTDD_DATABASE_HOST'],
       'PORT': os.environ['BuscoAyudaTDD_DATABASE_PORT'],
   }
}
# Password validation
